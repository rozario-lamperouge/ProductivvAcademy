...
from users.views import LoginView, RegisterView, ActiveUserView, ForgetPwdView, \
    ResetView, ModifyPwdView, LogoutView, IndexView, ContactView
...
urlpatterns = [
    ...
    # Configure the processing of uploaded file pictures
    # re_path('media/(?P<path>.*)/', serve, {'document_root': MEDIA_ROOT}),
    re_path(r'^media/(?P<path>.*)', serve, {"document_root": MEDIA_ROOT}),

    # When debug is set to false, you need to manually configure STATIC
